<%-- 
    Document   : Cpass2
    Created on : 07/10/2017, 12:19:44 PM
    Author     : Jose Rayo
--%>
...
<html>
    <head>
        ...
        <title>Institución Educativa El Buen Pasto</title>
    </head>
    <body class="nav-md">
                                    ...
                                    <div class="x_content">
                                        <div class="col-md-3 col-sm-3 col-xs-12 profile_right">
                                            <div class="profile_img">
                                                <div id="crop-avatar">
                                                    <!-- Current avatar -->
                                                    <img class="img-responsive avatar-view" src="recursos/img/user1.PNG" alt="Avatar" title="Change the avatar">
                                                </div>
                                            </div>
                                            <h3>Jean Paul Moron</h3>
