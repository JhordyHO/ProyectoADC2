<%-- 
    Document   : Rmobiliario2
    Created on : 07/10/2017, 12:52:01 PM
    Author     : Jose Rayo
--%>
                    ...
                    <div class="">
                        <div class="page-title">
                            <div class="title_left">
                                <h3>Inventario del Mobiliario</h3>
                            </div>
                        </div>
                                        ...
                                        <table id="datatable" class="table table-striped table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-hide="phone">Bueno</th>
                                                    <th data-hide="phone">Regular</th>
                                                    <th data-hide="phone">Malo</th>
                                                </tr>
                                            </thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><button type="button" class="btn btn-round btn-primary">Bueno</button></td>
                                                    <td><button type="button" class="btn btn-round btn-warning">Regular</button></td>
                                                    <td><button type="button" class="btn btn-round btn-danger">Malo</button></td>
                                                </tr>
                                                <tr>
                                                    <td>2</td>
                                                    <td>Escritorios</td>
